...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80043d:	50                   	push   %eax
  80043e:	68 73 11 80 00       	push   $0x801173
  800443:	53                   	push   %ebx
  800444:	56                   	push   %esi
  ...
  800458:	52                   	push   %edx
  800459:	68 7c 11 80 00       	push   $0x80117c
  80045e:	53                   	push   %ebx
  80045f:	56                   	push   %esi
  ...
  800483:	b8 6c 11 80 00       	mov    $0x80116c,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800dbe:	75 3e                	jne    800dfe <set_pgfault_handler+0x4d>
		// First time through!
  ...
  800ddb:	68 d0 13 80 00       	push   $0x8013d0
  800de0:	6a 20                	push   $0x20
  800de2:	68 f4 13 80 00       	push   $0x8013f4
  800de7:	e8 36 f3 ff ff       	call   800122 <_panic>
		sys_env_set_pgfault_upcall(0,_pgfault_upcall);
  800dec:	83 ec 08             	sub    $0x8,%esp
  800def:	68 08 0e 80 00       	push   $0x800e08
  800df4:	6a 00                	push   $0x0
  800df6:	e8 10 ff ff ff       	call   800d0b <sys_env_set_pgfault_upcall>
...
_pgfault_upcall:
  ...
  800e09:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
