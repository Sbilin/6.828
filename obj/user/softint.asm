...
sys_env_destroy(envid_t envid)
{
  ...
  8000fa:	68 ee 0d 80 00       	push   $0x800dee
  8000ff:	6a 23                	push   $0x23
  800101:	68 0b 0e 80 00       	push   $0x800e0b
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80014e:	56                   	push   %esi
  80014f:	50                   	push   %eax
  800150:	68 1c 0e 80 00       	push   $0x800e1c
  ...
  800161:	e8 54 00 00 00       	call   8001ba <vcprintf>
	cprintf("\n");
  800166:	c7 04 24 40 0e 80 00 	movl   $0x800e40,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002b9:	0f be 80 42 0e 80 00 	movsbl 0x800e42(%eax),%eax
  8002c0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037b:	ff 24 85 d0 0e 80 00 	jmp    *0x800ed0(,%eax,4)
  ...
  80043d:	83 f8 06             	cmp    $0x6,%eax
  800440:	7f 0b                	jg     80044d <vprintfmt+0x145>
  800442:	8b 14 85 28 10 80 00 	mov    0x801028(,%eax,4),%edx
  800449:	85 d2                	test   %edx,%edx
  80044b:	75 1b                	jne    800468 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80044d:	50                   	push   %eax
  80044e:	68 5a 0e 80 00       	push   $0x800e5a
  800453:	53                   	push   %ebx
  800454:	56                   	push   %esi
  ...
  800468:	52                   	push   %edx
  800469:	68 63 0e 80 00       	push   $0x800e63
  80046e:	53                   	push   %ebx
  80046f:	56                   	push   %esi
  ...
  800493:	b8 53 0e 80 00       	mov    $0x800e53,%eax
