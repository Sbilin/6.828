...
sys_env_destroy(envid_t envid)
{
  ...
  800ae9:	68 64 12 80 00       	push   $0x801264
  800aee:	6a 23                	push   $0x23
  800af0:	68 81 12 80 00       	push   $0x801281
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b6a:	68 64 12 80 00       	push   $0x801264
  800b6f:	6a 23                	push   $0x23
  800b71:	68 81 12 80 00       	push   $0x801281
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bac:	68 64 12 80 00       	push   $0x801264
  800bb1:	6a 23                	push   $0x23
  800bb3:	68 81 12 80 00       	push   $0x801281
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bee:	68 64 12 80 00       	push   $0x801264
  800bf3:	6a 23                	push   $0x23
  800bf5:	68 81 12 80 00       	push   $0x801281
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c30:	68 64 12 80 00       	push   $0x801264
  800c35:	6a 23                	push   $0x23
  800c37:	68 81 12 80 00       	push   $0x801281
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c72:	68 64 12 80 00       	push   $0x801264
  800c77:	6a 23                	push   $0x23
  800c79:	68 81 12 80 00       	push   $0x801281
...
sys_ipc_recv(void *dstva)
{
  ...
  800cd6:	68 64 12 80 00       	push   $0x801264
  800cdb:	6a 23                	push   $0x23
  800cdd:	68 81 12 80 00       	push   $0x801281
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d0b:	56                   	push   %esi
  800d0c:	50                   	push   %eax
  800d0d:	68 90 12 80 00       	push   $0x801290
  ...
  800d1e:	e8 c5 f3 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800d23:	c7 04 24 b4 12 80 00 	movl   $0x8012b4,(%esp)
